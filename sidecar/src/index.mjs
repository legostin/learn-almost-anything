...
const methods = {
  ...
  submodule_style_review: async (params, ctx) => pickAgent(params).submoduleStyleReview(params, ctx),
  generate_style_preview: async (params, ctx) => pickAgent(params).generateStylePreview(params, ctx),
  ...
  image_search_query: async (params, ctx) => pickAgent(params).imageSearchQuery(params, ctx),
